 ...
 * @author Jose
 */
public class TextFieldAnimation extends JTextField implements KeyListener {
    // Getteo y Setteo
    ...
    // Variables locales
    private Color backgroundColor = new Color(47,47,47);
    private Color animationColor = new Color(92,56,255);
    private final Icon iconSearch;
    private final Icon iconClose;
    private final Icon iconLoading;
    private String hintText = "Buscar producto";
    ...
    public TextFieldAnimation() {
        ...
        setSelectionColor(new Color(92, 56, 255));
    ...
    // Metodos de key para el buscador de productos
    @Override
