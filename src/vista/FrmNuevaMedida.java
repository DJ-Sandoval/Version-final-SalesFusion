 ...
 * @author Jose
 */
public class FrmNuevaMedida extends javax.swing.JDialog implements ActionListener, KeyListener {
    private PanelAdmin views;
    private Medidas med;
    private MedidaDao mdDao;
    private MedidaController mc;
    /**
     * Creates new form FrmNuevaMedida
     */
    public FrmNuevaMedida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Crear Medida");
        this.views = views;
    ...
    private void txtNombreMedKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreMedKeyPressed
        if (evt.getKeyCode() == evt.VK_ENTER) {
            txtNombreCortoMed.requestFocus();
        }
    }//GEN-LAST:event_txtNombreMedKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmNuevaMedida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmNuevaMedida dialog = new FrmNuevaMedida(new javax.swing.JFrame(), true);
